module.exports = class NeoxrApi {
   ...
   emojimix = async (emoticon) => {
  	let json = await Func.fetchJson(this.baseUrl + '/emoji?q=' + encodeURIComponent(emoticon) + '&apikey=QTnyev')
      return json
   }
   ...
   video = async (query) => {
      let json = await Func.fetchJson(this.baseUrl + '/video?q=' + query + '&apikey=QTnyev')
      return json
   }
   
   youtube = async (url, type = 'video', quality = '480p') => {
      let json = await Func.fetchJson(this.baseUrl + '/youtube?url=' + url + '&type=' + type + '&quality=' + quality + '&apikey=QTnyev')
      return json
   }
   ...
   npm = async (query) => {
      let json = await Func.fetchJson(this.baseUrl + '/npm?q=' + query + '&apikey=QTnyev')
      return json
   }
